      ...
      <div  className="drawer">
        {
          ...
          <div className="cartItems" > 
            ...
            <div className="textPopUp">
              ...
              <div className="PopUpPrice">{obj.price1}<i class="fa-solid fa-ruble-sign"/> / {obj.price2}<i class="fa-solid fa-ruble-sign"/></div>
              <div className="PopUpInfa">{obj.infa}</div>
              <div className="PopUpSostav">Состав: {obj.sost}</div>
            </div>
            
            <button className='btnPopUpClose' onClick={()=>onRemove(obj.name)} >
